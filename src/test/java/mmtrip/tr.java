...
public class tr extends javascript_utiljava {
	WebDriver driver;
	@BeforeTest
	...
	public void testcase2() throws InterruptedException {
        ...
        Thread.sleep(6000);
        v.dragAndDropBy(slider,-170,0).build().perform();
        Thread.sleep(5000);
        JavascriptExecutor js= ((JavascriptExecutor)driver);
        js.executeScript("window.scroll(0,1000)");
        Thread.sleep(5000);
        driver.findElement(By.xpath("//*[@class='flexOne makeFlex']/div[3]//div/div//div/div[5]")).click();
        Thread.sleep(5000);
